...
// Register Custom Post Type Aula
function create_aula_cpt() {
	...
	$labels = array(
		...
		'add_new_item' => 'Nova Aula',
		'add_new' => 'Adicionar nova',
		'new_item' => 'Nova Aula',
		'edit_item' => 'Editar Aula',
		'update_item' => 'Atualizar Aula',
		'view_item' => 'Ver Aula',
		'view_items' => 'Ver Aulas',
		'search_items' => 'Pesquisar Aula',
...
add_action( 'init', 'create_aula_cpt', 0 );


function son_set_post_per_page( $query ) {
	// Don't change in WordPress admin
	if ( is_admin() || !$query->is_main_query() )
			return;

	//Display 20 posts for a custom post type called 'movie'
	if ( $query->is_main_query() && $query->is_post_type_archive( 'aula' ) ) {
			$query->query_vars['posts_per_page'] = 15;
			return;
	}
}
add_action( 'pre_get_posts', 'son_set_post_per_page', 1 );
